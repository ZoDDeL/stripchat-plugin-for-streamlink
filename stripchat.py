...
class Stripchat(Plugin):
    ...
    def _get_streams(self):
        ...
        server = "https://edge-hls.doppiocdn.com/hls/{1}/master/{1}_auto.m3u8".format(data["cam"],data["cam"]["streamName"])

        server0 = "https://edge-hls.doppiocdn.com/hls/{1}/{1}_auto.m3u8".format(data["cam"],data["cam"]["streamName"])
